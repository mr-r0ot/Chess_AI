...
2. Install the required libraries using pip:
   ...
   ```
3. Download the Stockfish engine from [here](https://stockfishchess.org/download/).
4. Extract the ZIP file and place the folder in the same directory as this script.
